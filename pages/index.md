  ...
  <div class="container">
    <div class="hero-content">
      <div class="hero-text">
        ...
        <h1><strong>Avuta franck</strong></h1>
        <p class="tagline">Développeur passionné par la programmation desktop, les projets innovants et le partage de connaissances.</p>
  ...
  <div class="container">
    ...
    <div class="about-content">
      <div class="about-text">
        <p>Développeur passionné par la programmation desktop, les projets innovants et le partage de connaissances.</p>
...
<section class="cta" id="contact">
  <div class="container">
    ...
    <div class="cta-buttons">
      <a href="mailto:franck@example.com" class="btn btn-primary">
        <i class="fas fa-envelope"></i>
        M'envoyer un email
      </a>
      <a href="https://github.com/franckbasaniavuta316-max" class="btn btn-secondary" target="_blank">
